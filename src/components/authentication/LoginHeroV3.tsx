import loginBgImage from '@public/images/authentication/auth-1.jpg';
        ...
        <div className="max-w-[1120px] mx-auto w-full">
          <div className="flex justify-center items-stretch gap-16">
            <RevealAnimation delay={0.1}>
              <div className="max-w-[400px] w-full bg-background-1 dark:bg-background-6 rounded-[20px] py-14 px-8">
                <form className="mb-6">
            ...
            <RevealAnimation delay={0.2} direction="up">
              <div className="hidden lg:block">
                <figure className="max-w-[656px] max-h-[770px] h-full w-full rounded-[20px] overflow-hidden">
