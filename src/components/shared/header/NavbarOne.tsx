  ...
  return (
    <MobileMenuProvider>
      <header>
        <div
          className={cn(
            'main-container fixed top-0 xl:top-5 left-1/2 z-50 mx-auto flex w-full -translate-x-1/2 items-center justify-between rounded-full xl:rounded-full px-5 py-2.5 transition-all duration-500 ease-in-out xl:py-0',
