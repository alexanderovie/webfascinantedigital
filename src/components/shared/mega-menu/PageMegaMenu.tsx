...
const PageMegaMenu = ({ className }: PageMegaMenuProps) => {
  return (
    <div>
      ...
      <div
        className={cn(
          'shadow-1 dark:border-background-5 border-stroke-4 dark:bg-background-6 pointer-events-none fixed top-full left-1/2 z-[60] mt-2 w-full max-w-[1290px] -translate-x-1/2 translate-y-10 overflow-hidden rounded-[20px] border bg-white opacity-0 transition-all duration-300 group-hover/nav:pointer-events-auto group-hover/nav:translate-y-0 group-hover/nav:opacity-100',
          className,
        )}>
