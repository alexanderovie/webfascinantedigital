...
export const servicesMegaMenuColumns: MegaMenuColumn[] = [
  {
    ...
    items: [
      ...
      { id: 'service-8', label: '08. Content Marketing', href: '/services/content-marketing' },
      { id: 'service-9', label: '09. Email Marketing', href: '/services/email-marketing' },
      { id: 'service-10', label: '10. PPC Management', href: '/services/ppc-management' },
      { id: 'service-11', label: '11. Social Media Management', href: '/services/social-media-management' },
      { id: 'service-12', label: '12. Conversion Rate Optimization', href: '/services/conversion-rate-optimization' },
    ],
  },
  {
    id: 'column-2',
    items: [
      { id: 'service-13', label: '13. Landing Page Design', href: '/services/landing-page-design' },
      { id: 'service-14', label: '14. E-commerce SEO', href: '/services/ecommerce-seo' },
      { id: 'service-15', label: '15. Local SEO Audit', href: '/services/local-seo-audit' },
      { id: 'service-16', label: '16. Technical SEO Audit', href: '/services/technical-seo-audit' },
      { id: 'service-17', label: '17. Competitor Analysis', href: '/services/competitor-analysis' },
      { id: 'service-18', label: '18. Keyword Research', href: '/services/keyword-research' },
      { id: 'service-19', label: '19. Link Building', href: '/services/link-building' },
      { id: 'service-20', label: '20. Content Strategy', href: '/services/content-strategy' },
      { id: 'service-21', label: '21. Video Marketing', href: '/services/video-marketing' },
      { id: 'service-22', label: '22. Influencer Marketing', href: '/services/influencer-marketing' },
      { id: 'service-23', label: '23. Brand Development', href: '/services/brand-development' },
      { id: 'service-24', label: '24. Web Analytics Setup', href: '/services/web-analytics-setup' },
    ],
  },
  {
    id: 'column-3',
    items: [
      ...
      { id: 'service-26', label: '26. Facebook Pixel Setup', href: '/services/facebook-pixel-setup' },
      { id: 'service-27', label: '27. CRM Integration', href: '/services/crm-integration' },
      { id: 'service-28', label: '28. Lead Generation', href: '/services/lead-generation' },
      { id: 'service-29', label: '29. Sales Funnel Design', href: '/services/sales-funnel-design' },
      { id: 'service-30', label: '30. A/B Testing', href: '/services/ab-testing' },
      { id: 'service-31', label: '31. Marketing Consulting', href: '/services/marketing-consulting' },
      { id: 'service-32', label: '32. Digital Strategy', href: '/services/digital-strategy' },
      { id: 'service-33', label: '33. Performance Marketing', href: '/services/performance-marketing' },
      { id: 'service-34', label: '34. Growth Hacking', href: '/services/growth-hacking' },
      { id: 'service-35', label: '35. Marketing ROI Analysis', href: '/services/marketing-roi-analysis' },
      { id: 'service-36', label: '36. Content Marketing', href: '/services/content-marketing' },
    ],
  },
];
