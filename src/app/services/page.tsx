...
export const metadata: Metadata = {
  title: 'Our Services',
  description:
    'Comprehensive digital marketing services including SEO, web development, Google Ads, and marketing automation. Drive growth with Fascinante Digital.',
  alternates: {
    canonical: '/services',
  },
};
  ...
  return (
    <Fragment>
      ...
      <main className="bg-background-1 dark:bg-background-6">
        <PageHero
          title="Our Services"
          heading="Marketing Services That<br />Drive Results"
